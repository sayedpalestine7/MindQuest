            ...
            return (
              <Button
                ...
                className={`w-full justify-start text-left border-2 transition-all duration-150 ${
                  isActive
                    ? "border-blue-600 bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 dark:from-blue-900/30 dark:via-purple-900/30 dark:to-pink-900/30"
                    : "border-gray-300 dark:border-gray-700 hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-gray-800"
                }`}
              >
