...
import TeacherSidebar from "../../student-chat/TeacherSidebar";
import ChatWindow from "../../student-chat/ChatWindow";

/**
 * StudentRightPanel - Tabbed interaction area for students
 * Manages tabs for Enrolled Courses and Chat with teachers
 */
            ...
            >
              {courses && courses.length > 0 ? (
                ...
                <div className="text-center py-12 text-gray-500">
                  <p className="text-lg">No courses enrolled</p>
                  <p className="text-sm mt-2">Browse courses to get started</p>
                </div>
              )}
            </motion.div>
          )}
            ...
            >
              ...
              <div className="flex-shrink-0 border-r border-slate-200 min-h-0">
                <TeacherSidebar
                  ...
                  onSelectUser={onSelectTeacher}
                  searchValue={teacherSearch}
                  onSearch={onSearchTeachers}
                  socket={socket}
                  studentId={studentId}
